...
public class RunnerPersistence {
    ...
    public static void main(String[] args) {
        ...
        HWDao hwDao = new InMemoryHomeWorkDaoImpl();
        ...
        Post post1 = new Post("Per Post 1", LocalDate.now(), "Per Author 1");
        Post post2 = new Post("Per Post 2", LocalDate.now(), "Per Author 2");
...
//      getAll
        ...
        List<HomeworkTask> listHWorkDB = hwDao.getAll();
...
//      save user
        ...
        hwDao.saveHW(homeworkTask1);
        hwDao.saveHW(homeworkTask2);
...
//      get object
        ...
        HomeworkTask hwGet = hwDao.getHWById(1);
